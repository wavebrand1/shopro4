...
const initializeComponentBuilder = () => {
    ...
    list.addEventListener('click',event=>{
        ...
        const columnElement=event.target.closest('[data-column]');if(columnElement&&!event.target.closest('[data-component-id],.builder-column-toolbar')){selectedSlot={sectionId:section.id,column:Number(columnElement.dataset.column)};render();return;}

...
const initializeComponentBuilder = () => {
    ...
    const synchronizeRichTextSources=()=>root.querySelectorAll('[data-rich-text-source]').forEach(source=>{const component=findComponent(source.closest('[data-component-id]')?.dataset.componentId);if(component)component.data[source.dataset.field]=source.value;});

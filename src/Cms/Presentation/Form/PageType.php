...
final class PageType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('editorMode', ChoiceType::class, ['label' => 'Rodzaj treści', 'choices' => ['Edytor tekstowy' => 'rich_text', 'Builder komponentów' => 'components']])
            ->add('content', TextareaType::class, ['label' => 'Treść', 'required' => false, 'attr' => ['rows' => 20, 'data-rich-text-editor' => true]])

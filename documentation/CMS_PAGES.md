...
- dostęp `Public`, `Registered` i `Membership` (egzekwowanie poziomu Membership zostanie
  podłączone wraz z modułem członkostw);
...
motywu i członkostw pozostają zależnościami kolejnych etapów migracji i nie są pozorowane

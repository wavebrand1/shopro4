...
final class AdminCmsTest extends WebTestCase
{
    ...
    public function testAdministratorCanLogInAndPublishPage(): void
    {
        ...
        $builderComponents = self::getContainer()->get(PageBuilderComponentRegistry::class);
        self::assertTrue($builderComponents->isRenderableEnabled('rich_text'));
        self::assertTrue($builderComponents->isRenderableEnabled('layout_section'));
        self::assertFalse($builderComponents->isRenderableEnabled('homepage'));
        self::assertFalse($builderComponents->isRenderableEnabled('unknown_component'));
